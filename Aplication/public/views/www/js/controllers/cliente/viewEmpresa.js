angular.module('starter.controllers')
    .controller('ClienteViewEmpresaCtrl', [
        '$scope', '$state', 'Empresa', '$ionicLoading', '$EmpresaInfo', '$localStorage', '$cart', '$ionicPopup',
        function ($scope, $state, Empresa, $ionicLoading, $EmpresaInfo, $localStorage, $cart, $ionicPopup) {
            $scope.empresas = [];
            $scope.status = 0;
