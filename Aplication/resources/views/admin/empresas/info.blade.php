...
@section('content')
    ...
    <h2>Empresa: <font color="#1e90ff">{{$empresa->nome_fantasia}} </font></h2>

    @include('errors._check')

    <div class="panel panel-default">
        {!! Form::model($empresa, ['route'=>['admin.configuracoes.update', $empresa->id]]) !!}
    </div>
    <div class="card">
        <div class="card-body card-padding">
            <div class="row" style="padding: 20px 20px 20px 20px">
                ...
                <div class="panel panel-default">
                    ...
                    <a href="/home" class="btn btn-primary" style="width: 100px">Voltar</a>
                </div>
            </div>
        </div>
    </div>
