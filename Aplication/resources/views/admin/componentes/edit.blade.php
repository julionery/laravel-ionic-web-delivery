...
@section('content')
    ...
    <h2>Editando Adicional: <font color="#1e90ff">{{$componente->nome}} </font></h2>

    @include('errors._check')

    <div class="panel panel-default">
        {!! Form::model($componente, ['route'=>['admin.componentes.update', $componente->id]]) !!}
    </div>
    <div class="card">
        <div class="card-body card-padding">
            <div class="row" style="padding: 20px 20px 20px 20px">
                ...
                <br><br><br>
                <div class="panel panel-default">
                    {!! Form::submit('Salvar Adicional', ['class'=> 'btn btn-primary']) !!}
